...
export const GET_MENU_ITEM_BY_RESTAURANT_ID_REQUEST =
  "GET_MENU_ITEM_BY_RESTAURANT_ID_REQUEST";
export const GET_MENU_ITEM_BY_RESTAURANT_ID_SUCCESS =
  "GET_MENU_ITEM_BY_RESTAURANT_ID_SUCCESS";
export const GET_MENU_ITEM_BY_RESTAURANT_ID_FAILURE =
  "GET_MENU_ITEM_BY_RESTAURANT_ID_FAILURE";

export const UPDATE_MENU_ITEM_AVALIBLITY_REQUEST =
  "UPDATE_MENU_ITEM_AVALIBLITY_REQUEST";
export const UPDATE_MENU_ITEM_AVALIBLITY_SUCCESS =
  "UPDATE_MENU_ITEM_AVALIBLITY_SUCCESS";
export const UPDATE_MENU_ITEM_AVALIBLITY_FAILURE =
